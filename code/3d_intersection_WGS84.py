"""
Το συγκεκριμένο αρχείο υπολογίζει τις συντεταγμένες ενός σημείου στο προβολικό σύστημα 
του ΕΓΣΑ 87. Βασική προϋπόθεση, να είναι γνωστές οι διορθωμένες εικονοσυντεταγμένες του 
